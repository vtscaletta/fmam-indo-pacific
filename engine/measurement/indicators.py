...
_THREAT = [
    ...
    Indicator(
        ...
        kind=Kind.LINEAR,
        low=0.0, high=365.0,
        title="Частотность инцидентов в зоне соприкосновения",
        source="Официальная статистика ведомств по каждому агенту",
    ),
    Indicator(
        key="affinity",
        var=Var.THREAT,
        kind=Kind.LINEAR,
        low=100.0, high=0.0,   # обращённая шкала, близость снижает угрозу
        applies_to=("jpn",),
