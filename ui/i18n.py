...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "report_sources": {"ru": "Источники калибровки", "en": "Calibration sources"},
    "report_sources_hint": {"ru": "Состоявшиеся факты, обосновывающие стартовые значения и реальность событий. Прогнозные годы ссылок не имеют.", "en": "Established facts behind the calibration. Forecast years carry no references."},
    "report_src_verified": {"ru": "визирован", "en": "verified"},
