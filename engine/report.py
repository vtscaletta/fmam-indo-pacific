...
def _gaps(traj, thresholds: dict, base_year: int) -> list:
    ...
    gaps = [
        ...
        "Параметризация перцептивного контура и весов влияния на основе экспертно-"
        "аналитического структурирования источников обеспечивает репрезентативность "
        "качественного профиля модели, но вносит неустранимую субъективность "
        "параметризации.",
    ]
